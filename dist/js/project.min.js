...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"BACKEND_HOST\": () => (/* binding */ BACKEND_HOST),\n/* harmony export */   \"getRequest\": () => (/* binding */ getRequest)\n/* harmony export */ });\nconst BACKEND_HOST = 'http://127.0.0.1:8000/api/v1'\n\nfunction getRequest(url, serializer) {\n    return fetch(url, {\n        method: \"GET\",\n        headers: {\n            'Content-Type': 'application/json;charset=utf-8'\n        },\n    })\n        .then(r => r.json())\n        .then(r => new Promise(resolve => setTimeout(() => resolve(r), 1000)))\n        .then(serializer)\n}\n\n//# sourceURL=webpack://testing-starting/./src/js/modules/requests.js?");
